...
app.use(cors({ origin: ["https://www.beckyandgerron.com","https://project-std.vercel.app"] })); //Allow request coming in from my front end React app which is deployed on vercel
